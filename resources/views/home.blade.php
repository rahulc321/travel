                                    ...
                                    <div>
                                        ...
                                        <div class="d-flex align-items-center mt-4">
                                            <span class="text-success fw-medium"><i
                                                    class="ti ti-trending-up me-1 fs-12 align-middle d-inline-flex"></i>0.75%</span>
                                    ...
                                    <div>
                                        ...
                                        <div class="d-flex align-items-center mt-4">
                                            <span class="text-danger fw-medium"><i
                                                    class="ti ti-trending-down me-1 fs-12 align-middle d-inline-flex"></i>1.63%</span>
                                            <span class="ms-2 fs-13">this year</span>
                                        </div>
                                    </div>
                                    <div>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-start justify-content-between sales-main-cards">
                                    <div>
                                        ...
                                        <div class="d-flex align-items-center mt-4">
                                            <span class="text-success fw-medium"><i
                                                    class="ti ti-trending-up me-1 fs-12 align-middle d-inline-flex"></i>0.94%</span>
                                            <span class="ms-2 fs-13">this year</span>
                                        </div>
                                    </div>
                                    <div>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-start justify-content-between sales-main-cards">
                                    <div>
                                        ...
                                        <h4 class="fw-semibold mb-0">
                                            <?php 
                                                        $activeMId = \DB::table('marchents')->where('status',1)->get();

                                                    
                                                   ?>
                                            @foreach($activeMId as $mid)
                                            <span class="badge bg-outline-danger mid">{{@$mid->marchent}}</span>
                                            @endforeach
                                        </h4>

                                        <div class="d-flex align-items-center mt-4">
                                            <span class="text-success fw-medium"><i
                                                    class="ti ti-trending-up me-1 fs-12 align-middle d-inline-flex"></i></span>
                                    ...
                                    <li>
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <div class="text-end w-25">
                                                <span
                                                    class="d-block fw-medium fs-14 mb-1">{{$user->total_lead_amount}}</span>
