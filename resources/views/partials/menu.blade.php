        ...
        <ul class="main-menu">
            ...
            <li class="slide">
                <a href='{{ route("admin.lead.index") }}'
                    class="side-menu__item {{ request()->is('admin/lead*') ? 'active' : '' }}">
            ...
            <li class="slide">
                <a href='{{ route("admin.card.index") }}'
                    class="side-menu__item {{ request()->is('admin/card*') ? 'active' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" height="24px" viewBox="0 0 24 24"
                        width="24px" fill="#5f6368">
                        <path d="M0 0h24v24H0V0z" fill="none" />
                        <path
            ...
            <li class="slide">
                <a href='{{ route("admin.ip-whitelist.index") }}'
                    class="side-menu__item {{ request()->is('admin/ip-whitelist*') ? 'active' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" height="24px" viewBox="0 0 24 24"
                        width="24px" fill="#5f6368">
                        <path d="M0 0h24v24H0V0z" fill="none" />
                        <path
            ...
            <li class="slide">
                <a href='{{ route("admin.merchant.index") }}'
                    class="side-menu__item {{ request()->is('admin/merchant*') ? 'active' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" height="24px" viewBox="0 0 24 24"
                        width="24px" fill="#5f6368">
                        <path d="M0 0h24v24H0V0z" fill="none" />
                        <path
