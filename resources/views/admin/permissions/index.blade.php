                    ...
                    <div class="col-xl-12">
                        <div class="card custom-card">
                            <div class="card-header">
                                ...
                                <a class="" href="{{ route('admin.permissions.create') }}" style="float:right !important"><span class="badge bg-outline-info">Add Permission</span></a>
                                    ...
                                    <table id="datatable-basic" class="table table-bordered text-nowrap w-100">
                                        ...
                                        @foreach($permissions as $key => $permission)
                                            <tr>
                                                ...
                                                <form id="deleteFrm{{$key}}" action="{{ route('admin.permissions.destroy', $permission->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
