    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card custom-card">
                ...
                <div class="card-body">
                    <form action='{{ route("admin.card.update",[$edit->id]) }}' method="POST"
                      ...
                      <select class="form-control" name="status">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" class="form-control" required="" name="phone"
                                placeholder="Enter Phone" value="{{$edit->phone}}">
                        </div>

                        <div class="col-md-6">
                            <label class="form-label">Notes<code>*</code></label>
                            <textarea name="note" id="notes" class="form-control" placeholder="Notes">{{$edit->note}}</textarea>
                        </div>
