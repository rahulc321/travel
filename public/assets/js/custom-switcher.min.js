...
function switcherClick() {
    ...
    let backgroundColor1Var = bgDefaultColor1Btn.addEventListener('click', () => {
        localStorage.setItem('bodyBgRGB', "4 65 158");
        localStorage.setItem('bodylightRGB', "10, 71, 164");
        ...
        document.querySelector('html').style.setProperty('--light-rgb', "10, 71, 164");
        document.querySelector('html').style.setProperty('--form-control-bg', "rgb(10, 71, 164)");
    ...
    let backgroundColor2Var = bgDefaultColor2Btn.addEventListener('click', () => {
        localStorage.setItem('bodyBgRGB', "29 125 104");
        localStorage.setItem('bodylightRGB', "32, 130, 109");
        html.setAttribute('data-theme-mode', 'dark');
        html.setAttribute('data-menu-styles', 'dark');
        html.setAttribute('data-header-styles', 'dark');
        document.querySelector('html').style.setProperty('--body-bg-rgb', localStorage.bodyBgRGB);
        document.querySelector('html').style.setProperty('--body-bg-rgb2', localStorage.bodylightRGB);
        document.querySelector('html').style.setProperty('--light-rgb', "32, 130, 109");
        document.querySelector('html').style.setProperty('--form-control-bg', "rgb(32, 130, 109)");
        document.querySelector('html').style.setProperty('--input-border', "rgba(255,255,255,0.1)");
        document.querySelector('html').style.setProperty('--gray-3', "rgba(255,255,255,0.1)");
        document.querySelector('#switcher-dark-theme').checked = true;
        document.querySelector('#switcher-menu-dark').checked = true;
    ...
    let backgroundColor3Var = bgDefaultColor3Btn.addEventListener('click', () => {
        localStorage.setItem('bodyBgRGB', "78 44 198");
        localStorage.setItem('bodylightRGB', "84, 49, 204");
        html.setAttribute('data-theme-mode', 'dark');
        html.setAttribute('data-menu-styles', 'dark');
        html.setAttribute('data-header-styles', 'dark');
        document.querySelector('html').style.setProperty('--body-bg-rgb', localStorage.bodyBgRGB);
        document.querySelector('html').style.setProperty('--body-bg-rgb2', localStorage.bodylightRGB);
        document.querySelector('html').style.setProperty('--light-rgb', "84, 49, 204");
        document.querySelector('html').style.setProperty('--form-control-bg', "rgb(84, 49, 204)");
        document.querySelector('html').style.setProperty('--input-border', "rgba(255,255,255,0.1)");
        document.querySelector('html').style.setProperty('--gray-3', "rgba(255,255,255,0.1)");
        document.querySelector('#switcher-dark-theme').checked = true;
        document.querySelector('#switcher-menu-dark').checked = true;
    ...
    let backgroundColor4Var = bgDefaultColor4Btn.addEventListener('click', () => {
        localStorage.setItem('bodyBgRGB', "8 116 183");
        localStorage.setItem('bodylightRGB', "14, 121, 190");
        html.setAttribute('data-theme-mode', 'dark');
        html.setAttribute('data-menu-styles', 'dark');
        html.setAttribute('data-header-styles', 'dark');
        document.querySelector('html').style.setProperty('--body-bg-rgb', localStorage.bodyBgRGB);
        document.querySelector('html').style.setProperty('--body-bg-rgb2', localStorage.bodylightRGB);
        document.querySelector('html').style.setProperty('--light-rgb', "14, 121, 190");
        document.querySelector('html').style.setProperty('--form-control-bg', "rgb(14, 121, 190)");
        document.querySelector('html').style.setProperty('--input-border', "rgba(255,255,255,0.1)");
        document.querySelector('html').style.setProperty('--gray-3', "rgba(255,255,255,0.1)");
        document.querySelector('#switcher-dark-theme').checked = true;
        document.querySelector('#switcher-menu-dark').checked = true;
    ...
    let backgroundColor5Var = bgDefaultColor5Btn.addEventListener('click', () => {
        localStorage.setItem('bodyBgRGB', "93 14 122");
        localStorage.setItem('bodylightRGB', "99, 20, 129");
        html.setAttribute('data-theme-mode', 'dark');
        html.setAttribute('data-menu-styles', 'dark');
        html.setAttribute('data-header-styles', 'dark');
        document.querySelector('html').style.setProperty('--body-bg-rgb', localStorage.bodyBgRGB);
        document.querySelector('html').style.setProperty('--body-bg-rgb2', localStorage.bodylightRGB);
        document.querySelector('html').style.setProperty('--light-rgb', "99, 20, 129");
        document.querySelector('html').style.setProperty('--form-control-bg', "rgb(99, 20, 129)");
        document.querySelector('html').style.setProperty('--input-border', "rgba(255,255,255,0.1)");
        document.querySelector('html').style.setProperty('--gray-3', "rgba(255,255,255,0.1)");
        document.querySelector('#switcher-dark-theme').checked = true;
        document.querySelector('#switcher-menu-dark').checked = true;
    ...
    let lightThemeVar = lightBtn.addEventListener('click', () => {
        lightFn();
        localStorage.setItem("vertixHeader", 'light');
    ...
    let lightMenuVar = lightMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("vertixMenu", 'light');
    });
    /* Light Menu End */
    ...
    let colorMenuVar = colorMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("vertixMenu", 'color');
    });
    /* Color Menu End */
    ...
    let gradientMenuVar = gradientMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("vertixMenu", 'gradient');
    });
    /* Gradient Menu End */
    ...
    let transparentMenuVar = transparentMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("vertixMenu", 'transparent');
    });
    ...
    let colorHeaderVar = colorHeaderBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("vertixHeader", 'color');
    });
    /* Color Header End */
    ...
    let gradientHeaderVar = gradientHeaderBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("vertixHeader", 'gradient');
    });
    /* Gradient Header End */
    ...
    let transparentHeaderVar = transparentHeaderBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("vertixHeader", 'transparent');
    });
    /* Transparent Header End */
     ...
     let defaultwidthVar = defaultwidthBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("vetrixdefaultwidth", true);

        localStorage.removeItem("vetrixboxed");

        localStorage.removeItem("vetrixfullwidth");
    ...
    let fullwidthVar = fullwidthBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("vertixfullwidth", true);
        localStorage.removeItem("vertixboxed");
        localStorage.removeItem("vetrixdefaultwidth");
    });
    ...
    let boxedVar = boxedBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("vertixboxed", true);
        localStorage.removeItem("vertixfullwidth");
        localStorage.removeItem("vetrixdefaultwidth");
        checkHoriMenu()
    });
    /* Boxed Layout End */
    ...
    let shadowVar = regular.addEventListener('click', () => {
        ...
        localStorage.setItem("vertixregular", true);
        localStorage.removeItem("vertixclassic");
        localStorage.removeItem("vertixmodern");
    });
    ...
    let noShadowVar = classic.addEventListener('click', () => {
        ...
        localStorage.setItem("vertixclassic", true);
        localStorage.removeItem("vertixregular");
        localStorage.removeItem("vertixmodern");
    });
    ...
    let modernVar = modern.addEventListener('click', () => {
        ...
        localStorage.setItem("vertixmodern", true);
        localStorage.removeItem("vertixregular");
        localStorage.removeItem("vertixclassic");
    });
    ...
    let fixedHeaderVar = fixedHeaderBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("vertixheaderfixed", true);
        localStorage.removeItem("vertixheaderscrollable");
    });

    let scrollHeaderVar = scrollHeaderBtn.addEventListener('click', () => {
        html.setAttribute('data-header-position', 'scrollable');
        localStorage.setItem("vertixheaderscrollable", true);
        localStorage.removeItem("vertixheaderfixed");
    });
    ...
    let fixedMenuVar = fixedMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("vertixmenufixed", true);
        localStorage.removeItem("vertixmenuscrollable");
    });

    let scrollMenuVar = scrollMenuBtn.addEventListener('click', () => {
        html.setAttribute('data-menu-position', 'scrollable');
        localStorage.setItem("vertixmenuscrollable", true);
        localStorage.removeItem("vertixmenufixed");
    });
    ...
    let closedVar = closedBtn.addEventListener('click', () => {
        closedSidemenuFn();
        localStorage.setItem("vertixverticalstyles", 'closed');
        document.querySelectorAll(".main-menu>li.open").forEach((ele)=>{
            if(!ele.classList.contains('active')){
                ele.classList.remove('open')
                ele.querySelector('ul').style.display = 'none'
    ...
    let detachedVar = detachedBtn.addEventListener('click', () => {
        detachedFn();
        localStorage.setItem("vertixverticalstyles", 'detached');
    });
    /* Hover Submenu End */
    ...
    let iconTextVar = iconTextBtn.addEventListener('click', () => {
        iconTextFn();
        localStorage.setItem("vertixverticalstyles", 'icontext');
    });
    ...
    let overlayVar = overlayBtn.addEventListener('click', () => {
        iconOverayFn();
        localStorage.setItem("vertixverticalstyles", 'overlay');
        document.querySelectorAll(".main-menu>li.open").forEach((ele)=>{
            if(!ele.classList.contains('active')){
                ele.classList.remove('open')
                ele.querySelector('ul').style.display = 'none'
    ...
    let doubleVar = doubleBtn.addEventListener('click', () => {
        doubletFn();
        localStorage.setItem("vertixverticalstyles", 'doublemenu');
    });
    ...
    let menuClickVar = menuClickBtn.addEventListener('click', () => {
        ...
        menuClickFn();
        localStorage.setItem("vertixnavstyles", 'menu-click');
        localStorage.removeItem("vertixverticalstyles");
        document.querySelectorAll(".main-menu>li.open").forEach((ele)=>{
            if(!ele.classList.contains('active')){
                ele.classList.remove('open')
    ...
    let menuhoverVar = menuHoverBtn.addEventListener('click', () => {
        html.removeAttribute('data-vertical-style');
        menuhoverFn();
        localStorage.setItem("vertixnavstyles", 'menu-hover');
        localStorage.removeItem("vertixverticalstyles");
    ...
    let iconClickVar = iconClickBtn.addEventListener('click', () => {
        html.removeAttribute('data-vertical-style');
        iconClickFn();
        localStorage.setItem("vertixnavstyles", 'icon-click');
        localStorage.removeItem("vertixverticalstyles");
    ...
    let iconhoverVar = iconHoverBtn.addEventListener('click', () => {
        html.removeAttribute('data-vertical-style');
        iconHoverFn();
        localStorage.setItem("vertixnavstyles", 'icon-hover');
        localStorage.removeItem("vertixverticalstyles");
    ...
    let verticalVar = verticalBtn.addEventListener('click', () => {
        ...
        // local storage
        localStorage.removeItem("vertixlayout");
        localStorage.setItem("vertixverticalstyles", 'default');
        verticalFn();
        setNavActive();
    ...
    let horiVar = horiBtn.addEventListener('click', () => {
        ...
        html.removeAttribute('data-vertical-style');
        //    local storage
        localStorage.setItem("vertixlayout", 'horizontal');
        localStorage.removeItem("vertixverticalstyles");
    ...
    let rtlVar = rtlBtn.addEventListener('click', () => {
        localStorage.setItem("vertixrtl", true);
        localStorage.removeItem("vertixltr");
        rtlFn(); 
    ...
    let ltrVar = ltrBtn.addEventListener('click', () => {
        //    local storage
        localStorage.setItem("vertixltr", true);
        localStorage.removeItem("vertixrtl");
        ltrFn();
        if (document.querySelector(".noUi-target")) {
            document.querySelectorAll(".noUi-origin").forEach((e) => {
...
function lightFn() {
    ...
    localStorage.removeItem("vertixbgColor");
    localStorage.removeItem("vertixheaderbg");
    localStorage.removeItem("vertixbgwhite");
    localStorage.removeItem("vertixmenubg");
    localStorage.removeItem("vertixmenubg");
    checkOptions();
...
function darkFn() {
    ...
    localStorage.removeItem("vertixlighttheme");
    localStorage.removeItem("bodyBgRGB");
    localStorage.removeItem("vertixbgColor");
    localStorage.removeItem("vertixheaderbg");
    localStorage.removeItem("vertixbgwhite");
...
function horizontalClickFn() {
    ...
    if(!localStorage.vertixMenu && !localStorage.bodylightRGB){
        html.setAttribute("data-menu-styles","dark")
        document.querySelector('#switcher-menu-dark').checked = true;
        checkOptions();
    }
...
function checkOptions() {
    ...
    // light header
    if (localStorage.getItem('vertixHeader') === "light") {
        document.querySelector('#switcher-header-light').checked = true;
    }

    // color header
    if (localStorage.getItem('vertixHeader') === "color") {
        document.querySelector('#switcher-header-primary').checked = true;
    }

    // gradient header
    if (localStorage.getItem('vertixHeader') === "gradient") {
        document.querySelector('#switcher-header-gradient').checked = true;
    }

    // dark header
    if (localStorage.getItem('vertixHeader') === "dark") {
        document.querySelector('#switcher-header-dark').checked = true;
    }
    // transparent header
    if (localStorage.getItem('vertixHeader') === "transparent") {
        document.querySelector('#switcher-header-transparent').checked = true;
    }

    // light menu
    if (localStorage.getItem('vertixMenu') === 'light') {
        document.querySelector('#switcher-menu-light').checked = true;
    }

    // color menu
    if (localStorage.getItem('vertixMenu') === 'color') {
        document.querySelector('#switcher-menu-primary').checked = true;
    }

    // gradient menu
    if (localStorage.getItem('vertixMenu') === 'gradient') {
        document.querySelector('#switcher-menu-gradient').checked = true;
    }

    // dark menu
    if (localStorage.getItem('vertixMenu') === 'dark') {
        document.querySelector('#switcher-menu-dark').checked = true;
    }
    // transparent menu
    if (localStorage.getItem('vertixMenu') === 'transparent') {
        document.querySelector('#switcher-menu-transparent').checked = true;
    }

    //boxed
    if (localStorage.getItem('vertixboxed')) {
        document.querySelector('#switcher-boxed').checked = true;
    }

    //scrollable
    if (localStorage.getItem('vertixheaderscrollable')) {
        document.querySelector('#switcher-header-scroll').checked = true;
    }
    if (localStorage.getItem('vertixmenuscrollable')) {
        document.querySelector('#switcher-menu-scroll').checked = true;
    }

    //fixed
    if (localStorage.getItem('vertixheaderfixed')) {
        document.querySelector('#switcher-header-fixed').checked = true;
    }
    if (localStorage.getItem('vertixmenufixed')) {
        document.querySelector('#switcher-menu-fixed').checked = true;
    }

    //classic
    if (localStorage.getItem('vertixclassic')) {
        document.querySelector('#switcher-classic').checked = true;
    }

    //modern
    if (localStorage.getItem('vertixmodern')) {
...
function localStorageBackup2() {
    ...
    if (localStorage.primaryRGB) {
        ...
        if (localStorage.primaryRGB == "143, 32, 133") {
